...
| 2 | `reporte-LLM.docx` + `reporte-OE1-metricas-oficiales.docx` | S2 | OE1 | ✅ | reporte-LLM = comparativa Sprint 2 (Likert/latencia/VRAM; nota: portada dice "OE2", etiqueta pre-v3.2). El anexo de métricas oficiales mide los 9 indicadores como evidencia. Criterio OE1 (set finalizado 2026-05-31) = instrumentos primarios: Accuracy 0.72, Likert 4.325, Recall@5 0.72, MRR@10 0.684, nDCG@10 0.686 → **5/5 cumplen**. ROUGE-L/BLEU/κ/STS retirados del criterio por inadecuación de instrumento; conservados como diagnóstico en el anexo |
| 3 | `arquitectura.docx` | S3 | OE3 | ✅ | Diagramas C4 + justificación stack + despliegue |
| 4 | `reporte-RAGAS.docx` | S4/S7 | OE2 | ✅ | Golden set 50 ítems · librería ragas oficial + juez independiente llama3.1 + rerank · precision 0.876 / recall 0.812 / faithfulness 0.706 / relevancy 0.707 / correctness 0.609 · criterio = 5 primarias → **5/5 cumplen** (umbrales generación recalibrados, asesora aprobó 2026-05-29; context_entity_recall 0.200 retirada del criterio por inadecuación de instrumento, set finalizado 2026-05-31) |
